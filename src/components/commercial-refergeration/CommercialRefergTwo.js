    ...
    <div className="air-cond-sys-cont">
      <div className="commercial-container flex">
        <p className="commercial-p">
          ...
          <span className="brand-color">
            {" "}
            vacuum cooling refrigeration systems.
          </span>{" "}
          We have over 10 years’ experience in the design, supply and
          installation of made to measure
          <span className="brand-color">
            {" "}
            cold rooms, cellar coolers, display refrigerators
          </span>{" "}
          and
          <span className="brand-color"> bespoke bar units</span> for all types
        ...
        <hr />
        <div>
          <h3>Commercial-Refrigeration Services</h3>
          <p>
        ...
        <div>
          ...
          <ul className="commercial-referg-li">
            <li>
              <span className="brand-color">
                Walk-in Fridge and Walk-in Freezers –{" "}
              </span>
        ...
        <div>
          ...
          <ul className="commercial-referg-li">
            <li>
              <span className="brand-color">Display Fridge</span>– wide range of
              single or double fronted glass door refrigerators for visual
              impact and with variable food display options
            </li>
            <li>
              <span className="brand-color">Counter Fridge</span>– space
              efficient, offering flexible food preparation
            </li>
            <li>
              <span className="brand-color">Free Standing Fridge</span>– fully
              automatic, fan assisted cooling in a range of sizes
            </li>
            <li>
              <span className="brand-color">Upright Fridge</span>– variable food
              display options
            </li>
            <li>
              <span className="brand-color">Drink Fridge</span>– chilled display
              fridge with single, half size or double door options
            </li>
          </ul>
        </div>
        <hr />
        <div>
          ...
          <ul className="commercial-referg-li">
            <li>
              <span className="brand-color">Upright Freezer</span>– space
              saving, practical and energy efficient
            </li>
            <li>
              <span className="brand-color">Chest Freezer</span>– reliable, high
              capacity for large volume freezing
            </li>
            <li>
              <span className="brand-color">Counter Freezer</span>– flexible
              solution for food preparation counter space
            </li>
          </ul>
        </div>
        <hr />
        ...
        <p>
          <span className="brand-color">
            <Link to="/contact-us" className="brand-color commercial-email">
              Contact us for No Obligation Survey
            </Link>
          </span>
        </p>
        <hr />
        <div>
          ...
          <p>
            JustCold Refrigeration are specialists in refrigeration services for
            commercial businesses in and around the Eroup area.. We can help
            your business operate in a more efficient and cost-effective way.{" "}
            <br /> <br />
          </p>
        </div>
        <hr />
        <p>
          Call <span className="brand-color">07473319304</span> today to talk to
          us about your refrigeration & air conditioning requirements.
        </p>
      </div>
